...
<div className='col-4 p-4 mt-2 mb-2'>
    <h4 style={{fontSize:"20px"}}><i class="fa fa-plus-circle" aria-hidden="true"></i>Account Opening</h4>
...
<div className='col-4 p-4 mt-2 mb-2'>
    <h4 style={{fontSize:"20px"}}><i class="fa fa-user-circle" aria-hidden="true"></i>Your Zerodha Account</h4>
...
<div className='col-4 p-4 mt-2 mb-2'>
    <h4 style={{fontSize:"20px"}}> <i class="fa fa-rocket" aria-hidden="true"></i> Trading and Markets</h4>
...
<div className='col-4 p-4 mt-2 mb-2'>
    <h4 style={{fontSize:"20px"}}><i class="fa fa-archive" aria-hidden="true"></i>Funds
    </h4>
...
<div className='col-4 p-4 mt-2 mb-2'>
    <h4 style={{fontSize:"20px"}}> <i class="fa fa-codiepie" aria-hidden="true"></i>
    Console</h4>

<a href=''style={{textDecoration:"none",lineHeight:"2"}}>IPO </a><br/>
<a href='' style={{textDecoration:"none",lineHeight:"2"}}>Portfolio
</a><br/>
...
<div className='col-4 p-4 mt-2 mb-2'>
    <h4 style={{fontSize:"20px"}}> <i class="fa fa-circle-o-notch" aria-hidden="true"></i></h4>
...
<a href=''style={{textDecoration:"none",lineHeight:"2"}}>Transactions and reports
</a><br/>
