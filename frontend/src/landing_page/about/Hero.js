...
function Hero() {
    return (
        ...
        <div className='container'>
            ...
            <div className='row p-5 mt-5 border-top text-muted'style={{lineHeight:"1.8", fontSize:"1.1em ", marginTop:"20px"}}>
               ...
               <p>Over 1+ Crore clients place millions of orders every day through our powerful ecosystem of investment platforms, contributing over 15% of all Indian retail trading volumes.</p><br/>
                ...
                <p>And yet, we are always up to something new every day. Catch up on the latest updates on our blog or see what the media is <a href='' style={{textDecoration:"none"}}>saying about us.</a></p><br/>
                </div>
